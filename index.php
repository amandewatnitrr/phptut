  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="./index.php"><button type="button" class="btn btn-primary" style="margin-left: 10px;">PHP 101</button></a>
        </li>
        ...
        <button type="button" class="btn btn-danger" style="margin-left: 10px;">Lessons</button>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#">PHP 102</a></li>
        ...
        <button type="button" class="btn btn-warning" style="margin-left: 10px;">Social Media/Coding Platform</button>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="https://www.linkedin.com/in/aman-kumar-dewangan-akd13o1/">Linkedin</a></li>
            <li><a class="dropdown-item" href="https://www.instagram.com/akd_beast_slayer/">Instagram</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="https://github.com/amandewatnitrr">Github</a></li>
            <li><a class="dropdown-item" href="https://www.hackerrank.com/amandewatnitrr?hr_r=1">Hackerrank</a></li>
            <li><a class="dropdown-item" href="https://www.codechef.com/users/amandewatnitrr">Codechef</a></li>
          </ul>
        </li>
...
?>';highlight_string($code);?></b><br>
            ...
            <div class="list-group-item list-group-item-success"><h3>Loops in PHP</h3>(click on the button to view details.)</div>
            <div class="list-group-item list-group-item-info">
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal1">While Loop</button>
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal2">For Loop</button>
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal3">Do While Loop</button>
            <br><br>
            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal4">For each Loop</button>
            </div>
...
?>';highlight_string($code);?></b><br>
    ...
    <?php
        echo "<br>This Webpage is being developed by Aman Kumar Dewangan using PHP.";
    ?>
    <div class="alert alert-warning alert-dismissible fade show" role="alert">
        <strong>The Website is made using HTML, Bootstrap and PHP,</strong> and is only for educational purpose.
