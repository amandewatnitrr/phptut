  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><div class="g-signin2" style="margin:8px;" data-onsuccess="onSignIn"></div></li>
        ...
        <button type="button" class="btn btn-danger" style="margin-left: 10px;">Lessons</button>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="./php103.php">PHP 103</a></li>
            <li><a class="dropdown-item" href="./php104.php">PHP 104</a></li>
            <li><a class="dropdown-item" href="./php105.php">PHP 105</a></li>
